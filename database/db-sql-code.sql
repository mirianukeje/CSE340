...
ALTER TYPE public.account_type OWNER TO cse340mu;
...
CREATE TABLE IF NOT EXISTS public.review (
  ...
  review_created timestamp with time zone NOT NULL DEFAULT now(),
  CONSTRAINT review_pkey PRIMARY KEY (review_id),
  CONSTRAINT fk_review_inventory FOREIGN KEY (inv_id) REFERENCES public.inventory (inv_id) ON DELETE CASCADE,
  CONSTRAINT fk_review_account FOREIGN KEY (account_id) REFERENCES public.account (account_id) ON DELETE SET NULL
);
